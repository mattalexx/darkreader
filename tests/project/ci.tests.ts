        ...
        const tests: Test[] = [
            {
                ...
                browserBins: {CHROME_BIN: 'bins/stable/google-chrome'},
            ...
            },
            {
                ...
                browserBins: {CHROME_BIN: 'bins/stable/google-chrome', FIREFOX_BIN: 'bins/latest/firefox'},
                wantBrowsers: ['CIChromeHeadless', 'CIFirefoxHeadless'],
                wantLaunchersIncluded: ['CIChromeHeadless', 'CIFirefoxHeadless'],
                wantError: false,
            },
            {
                title: 'firefox incorrect executable path',
                params: {firefox: 'latest-beta'},
                browserBins: {FIREFOX_BIN: 'bins/nope/firefox'},
                wantError: true,
            },
            {
                title: 'no browsers',
